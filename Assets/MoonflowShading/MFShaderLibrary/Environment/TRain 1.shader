...
Shader "Moonflow/Test/Rain"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_RainDropTex("RainDropTex", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float localRainDrop12 = ( 0.0 );
				float2 uv_RainDropTex = IN.ase_texcoord8.xy * _RainDropTex_ST.xy + _RainDropTex_ST.zw;
				float4 tex2DNode13 = tex2D( _RainDropTex, uv_RainDropTex );
				float2 appendResult14 = (float2(tex2DNode13.r , tex2DNode13.g));
				float2 uvNormal12 = appendResult14;
				float maskB12 = tex2D( _RainDropTex, uv_RainDropTex ).b;
				float maskA12 = tex2D( _RainDropTex, uv_RainDropTex ).a;
				float timeScale12 = _TimeScale;
				float3 normal12 = float3( 0,0,0 );
				float mask12 = 1;
				float strength12 = ( pow( saturate( WorldNormal.y ) , 4.0 ) * _Strength );
				{
				normal12 = normalize(float3(uvNormal12 * 2 - 1, 1));
				float animMask = saturate(maskA12 * 2 - 1);
				float temperalMask = frac(maskB12 - _Time.x * timeScale12);
				float totalMask = animMask * temperalMask;
				float littleMask =floor(1.1-maskA12);
				mask12 =  (totalMask+saturate(littleMask));
				normal12 = lerp(float3(.5,.5,1), normal12,  mask12 * strength12 );
				mask12 = saturate(mask12 *strength12)*0.75+0.25;
				}
				
				float3 Albedo = float3(0.5, 0.5, 0.5);
				float3 Normal = normal12;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0.0;
				float Smoothness = mask12;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float localRainDrop12 = ( 0.0 );
				float2 uv_RainDropTex = IN.ase_texcoord4.xy * _RainDropTex_ST.xy + _RainDropTex_ST.zw;
				float4 tex2DNode13 = tex2D( _RainDropTex, uv_RainDropTex );
				float2 appendResult14 = (float2(tex2DNode13.r , tex2DNode13.g));
				float2 uvNormal12 = appendResult14;
				float maskB12 = tex2D( _RainDropTex, uv_RainDropTex ).b;
...
/*ASEBEGIN
Version=18935
-2380;312;2300;1022;2111.014;619.959;1.440227;True;True
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;-791.0247,812.0643;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;48;-1719.271,-173.4889;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;44;-1945.386,-105.7982;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;40;-2076.144,-230.0757;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;100;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;41;-2718.049,-242.3204;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;45;-2695.744,-104.3581;Inherit;False;Constant;_Vector1;Vector 1;4;0;Create;True;0;0;0;False;0;False;1,1,0.1,0.2;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;46;-2450.906,-55.39039;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;43;-2283.838,-131.7224;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.OneMinusNode;49;-1513.32,-118.7603;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;32;-967.7855,679.3321;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;4;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;50;-1282.883,-85.63506;Inherit;False;Normal From Height;-1;;1;1942fe2c5f1a1f94881a33d532e4afeb;0;2;20;FLOAT;0;False;110;FLOAT;1;False;2;FLOAT3;40;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-156.6897,-250.6052;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;12;-593.9733,139.0874;Inherit;False;normal = normalize(float3(uvNormal * 2 - 1, 1))@$$float animMask = saturate(maskA * 2 - 1)@$float temperalMask = frac(maskB - _Time.x * timeScale)@$float totalMask = animMask * temperalMask@$float littleMask =floor(1.1-maskA)@$mask =  (totalMask+saturate(littleMask))@$normal = lerp(float3(.5,.5,1), normal,  mask * strength )@$mask = saturate(mask *strength)*0.75+0.25@$$;7;Create;7;True;uvNormal;FLOAT2;0.5,0.5;In;;Inherit;False;True;maskB;FLOAT;0;In;;Inherit;False;True;maskA;FLOAT;0;In;;Inherit;False;True;timeScale;FLOAT;1;In;;Inherit;False;True;normal;FLOAT3;0,0,0;Out;;Inherit;False;True;mask;FLOAT;1;Out;;Inherit;False;True;strength;FLOAT;1;In;;Inherit;False;RainDrop;True;False;0;;False;8;0;FLOAT;0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;1;False;5;FLOAT3;0,0,0;False;6;FLOAT;1;False;7;FLOAT;1;False;3;FLOAT;0;FLOAT3;6;FLOAT;7
Node;AmplifyShaderEditor.WorldNormalVector;27;-1615.601,593.4133;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;13;-1155.551,110.821;Inherit;True;Property;_RainDropTex;RainDropTex;0;0;Create;True;0;0;0;False;0;False;-1;df8a15635f3c79f40825c5969c69eac6;df8a15635f3c79f40825c5969c69eac6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;28;-1188.23,642.1934;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;14;-808.5511,108.821;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-939.1658,320.2603;Inherit;False;Property;_TimeScale;TimeScale;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-1396.049,645.7338;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;-1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-1278.255,949.797;Inherit;False;Property;_Strength;Strength;2;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;49.48581,-248.3803;Inherit;False;Constant;_Float1;Float 1;4;0;Create;True;0;0;0;False;0;False;0.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-1526.64,-27.3643;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
