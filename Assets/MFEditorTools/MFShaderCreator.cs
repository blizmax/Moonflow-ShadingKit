...
namespace Moonflow
{
    public class MFShaderCreator
    {
        [MenuItem("Assets/Create/Moonflow/Create Shader/Create CG Includes")]
        ...
        [MenuItem("Assets/Create/Moonflow/Create Shader/Create HLSL Includes")]
        ...
        [MenuItem("Assets/Create/Moonflow/Create Shader/Create URPUnlit")]
        ...
        {
            string template = "";
            template += "#ifndef MF_UTILITY_INCLUDED\n"+
